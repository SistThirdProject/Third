		...
		<div class="centerContainer">
			<div class="oneThirdCol">
				...
				<ul id="tweetList">
					<li>
						<p>
							I'm looking for some cool web design #contract templates for
							#freelancers, any suggestions? <span>3 days ago</span>
						</p>
					</li>
					<li>
						<p>
							<a href="#">@mediatemple</a> will definitely do that, thanks :) <span>6
								days ago</span>
						</p>
					</li>
					<li>
						<p>
							Now coding the Corpora Business Theme, having fun :D <span>13
								days ago</span>
						</p>
					</li>
				</ul>
			...
			<div class="oneThirdCol">
				...
				<p>Enter your email address below to subscribe. You will receive
					our newsletter once a week.</p>
				...
				<p>
					<a href="#">Terms of Use</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">Privacy
						Policy</a>
				</p>
			</div>
			<div class="oneThirdCol lastCol">
				...
				<p>
					You can contact us by using the contact information below or by
					sending us a message via our <a href="#">contact form</a>.
				</p>
				<ul id="contactInfoList">
					<li>85 Washington Ave., Suite 45, CA, USA</li>
					<li>Phone: 1.800.CORP (1.800.2577)</li>
					<li>Email: <a href="#">office@corpora.com</a></li>
				</ul>
			</div>
		</div>
	</div>
