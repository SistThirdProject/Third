	  ...
	  <div id="leftContainer" class="fl">
	    ...
	    <ul id="newsList">
	      <li> <span>October 1st, 2011</span>
	        ...
	        <a href="#" class="readMoreLink">Read more</a> </li>
	      <li> <span>October 1st, 2011</span>
	        <h3><a href="#">New tutorial on Webdesign Tuts+</a></h3>
	        <p>Phasellus euismod luctus augue at pellentesque. Curabitur rutrum vehicula est at dignissim. Curabitur quam eros, dapibus eu aliquam sed, feugiat in lorem. </p>
	        <a href="#" class="readMoreLink">Read more</a> </li>
	      <li> <span>October 1st, 2011</span>
	        <h3><a href="#">600,000 members for Envato Marketplaces</a></h3>
	        <p>Phasellus euismod luctus augue at pellentesque. Curabitur rutrum vehicula est at dignissim. Curabitur quam eros, dapibus eu aliquam sed, feugiat in lorem. </p>
	        <a href="#" class="readMoreLink">Read more</a> </li>
	    </ul>
	  </div>
	  <div id="rightContainer" class="fr">
	    <h3 class="sectionTitle">about <span>the company</span></h3>
	    ...
	    <blockquote>
	      <p>Wow, you guys are just awesome. Dave in particular was simply amazing, he helped me understand the process so I got around the paperwork so quickly.</p>
